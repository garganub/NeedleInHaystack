        ...
        for Nletter in needle: 
            ...
            if Nletter == Hletter: 
                ...
                if N_index_counter == 0:
                    ...
                    print("Start index is found, should be returning " + str(start_index))
                    return start_index
                H_index_counter += 1
                ...
                start_index = -1
                print("We know that this Needle character it is not the beginning of Needle. The haystack needle pair is " + Hletter + Nletter)
                break
            N_index_counter += 1 
        N_index_counter = 0        
        H_index_counter += 1       
